...
if __name__ == '__main__':
    ...
    log_path = "/home/hjh/WindPowerForecast/logs/KGformer_noKG_log_12h"
    ...
    typhoon_valiset = Dataset_Typhoon_KGraph(flag='test')
    typhoon_vali_loader = DataLoader(typhoon_valiset, batch_size=args.batch_size, shuffle=False, drop_last=True)
